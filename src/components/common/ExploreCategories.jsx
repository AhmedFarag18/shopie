...
import category_img from "../../assets/Blueberry - eCommerce/newsletter.jpg"
...
export default function ExploreCategories() {
  ...
  return (
    <section className="bg-white px-10 py-20 flex flex-col md:flex-row justify-center items-center gap-10 max-md:p-3">
      <div className="relative rounded-2xl overflow-hidden shadow-lg w-1/3 h-[400px] bg-gray-200 max-md:w-full max-md:h-auto">
        <img src={category_img} className="w-full h-full object-cover" />
